<section>
    <div class="section-segment">
        <h3>Abstracts</h3>
        <p>All entries contain an abstract. Abstracts are collaboratively written by members of the skeletal dysplasia
    ...
    <div class="section-segment">
        ...
        <p>X-rays are contributed by members of the skeletal dysplasia community to illustrate the radiographic
            ...
            Click the small arrows on the images to move back and forth through the series of images.</p>
    </div>

    <div class="section-segment">
        <h3>Clinical Features</h3>

        <p>Every bone dysplasia entry contains a list of clinical features deemed characteristic for this disorder.
            The original list was sourced from [OMIM], but can be edited by the skeletal dysplasia community.
