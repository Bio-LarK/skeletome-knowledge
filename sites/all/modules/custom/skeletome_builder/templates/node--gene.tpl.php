    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="span8">
                ...
                <section class="section-large section-large-description" ng-class="{'section-more': master.gene.body.und[0].safe_value.length > view.descriptionLength}">
                ...
                <section class="section-large section-large-noborder section-more" ng-controller="StatementCtrl">

                    <?php if ($user->uid): ?>
                        <a class="btn btn-success pull-right" ng-click="showAddStatement()" href><i class="icon-plus icon-white"></i> Add Statement</a>
                    <?php else: ?>
                        <a class="btn btn-success pull-right" href cm-popover="top" cm-popover-content="'<b>Log in</b> to Skeletome to add a statement.'"><i class="icon-plus icon-white"></i> Add Statement</a>
                    <?php endif; ?>
                    ...
                    <h2>Statements</h2>
                    <p class="muted" ng-hide="statements.length">
                        Add a new statement about '{{ master.gene.title }}'.
                    </p>
                    <div ng-show="statements.length > 0" class="statements">
                        ...
                        <div class="statement" ng-repeat="statement in statements | limitTo: statementDisplayLimit" style="margin-bottom: 21px" >
                            ...
                            <div class="media-body">
                                ...
                                <div class="statement-content">
                                    <div ng-bind-html-unsafe="statement.body.und[0].safe_value || 'No statement.'"></div>
                                </div>
                    ...
                    <div class="clearfix">
                        <a ng-show="statementDisplayLimit < statements.length" ng-click="statementDisplayLimit = statements.length" href class="btn btn-more pull-right"><i class="icon-chevron-down icon-black"></i> Show All ({{statements.length - statementDisplayLimit}})</a>
                        <a ng-show="statementDisplayLimit == statements.length" ng-click="statementDisplayLimit = 2" href class="btn btn-more pull-right"><i class="icon-chevron-up icon-black"></i> Show Less</a>
                    </div>
                </section>
