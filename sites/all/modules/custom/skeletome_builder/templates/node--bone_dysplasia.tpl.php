...
<div ng-controller="BoneDysplasiaCtrl" ng-init="init()" class="node_page" xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <div class="container">
        <div class="row">
            <div class="span12">
                <div class="page-header">
                    ...
                    <a href="#new-bone-dysplasia" role="button" class="btn pull-right" data-toggle="modal" ><i class="icon-plus"></i> Add New Disorder</a>
                    <?php endif; ?>
                   ...
                   <!-- <ul class="breadcrumbs" ng-repeat="tag in tags">
                    ...
                    <h1 ng-show="!synString.length"><img src="<?php echo base_path() . drupal_get_path('module', 'skeletome_builder'); ?>/images/logo-large-bone-dysplasia.png"/> <?php print $title; ?> <small>Bone Dysplasia</small> </h1>
                    <h1 ng-cloak ng-show="synString.length" cm-tooltip="top" cm-tooltip-content="Also known as {{ synString }}"><img src="<?php echo base_path() . drupal_get_path('module', 'skeletome_builder'); ?>/images/logo-large-bone-dysplasia.png"/> <?php print $title; ?> <small>Bone Dysplasia</small> </h1>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="span8">
                ...
                <!-- The content -->
                <section ng-class="{'section-more': boneDysplasia.body.und[0].safe_value.length > descriptionLength}" class="section-large section-large-description">
                    <div id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
                        ...
                        <div class="content"<?php print $content_attributes; ?>>
                            ...
                            <div class="pull-right">
                                <a href ng-click="showEditDescription()" data-toggle="modal" role="button" class="btn"><i class="icon-pencil"></i> Edit</a>
                            </div>
                            <?php endif; ?>

                            <h2>Description</h2>

                            <div ng-cloak class="description-text">
                                <p class="muted" ng-show="!boneDysplasia.body.und[0].safe_value.length">There is currently no description of '{{ boneDysplasia.title }}'.</p>
                                ...
                                <div ng-show="boneDysplasia.body.und[0].safe_value.length" >
                                    ...
                                    <div class="clearfix" style="text-align: center">
                                        <a href ng-show="boneDysplasia.body.und[0].safe_value.length > descriptionLength" class="btn btn-more" ng-click="descriptionLength=boneDysplasia.body.und[0].safe_value.length"><i class="icon-chevron-down icon-black"></i> Show All</a>
                                        <a href ng-show="descriptionLength == boneDysplasia.body.und[0].safe_value.length" class="btn btn-more" ng-click="descriptionLength=1000"><i class="icon-chevron-up icon-black"></i> Hide</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section class="section-large" ng-class="{'section-more': statementDisplayLimit < statements.length}" ng-controller="StatementCtrl">
                    <div class="pull-right">
                        <?php if ($user->uid): ?>
                            <a class="btn btn-success " ng-click="showAddStatement()"  href><i class="icon-plus icon-white"></i> Add Statement</a>
                        <?php else: ?>
                    ...
                    <p ng-cloak class="muted" ng-hide="statements.length">
                        Add a new statement about '{{ boneDysplasia.title }}'.
                    </p>
                        ...
                        <div class="statement" ng-repeat="statement in statements | limitTo: statementDisplayLimit" style="margin-bottom: 21px" >
                            ...
                            <div class="media-body">
                                ...
                                <div class="statement-buttons">
                                    <!-- Add Comment -->
                                    <?php if ($user->uid): ?>
                                    <a ng-hide="statement.showAddComment" ng-click="showAddComments(statement)" href><i class="icon-plus"></i> Add Comment</a>
                ...
                <!-- Clinical Features -->
                <section class="section-large section-large-noborder" ng-class="{'section-more': clinicalFeatures.length > clinicalFeatureDisplayLimit}" id="clinical_features" class="block">
                    <?php if((user_access('administer site configuration')) || is_array($user->roles) && in_array('sk_moderator', $user->roles)): ?>
                    <div class="pull-right">
                        <a href ng-click="showEditClinicalFeatures()" data-toggle="modal" role="button" class="btn"><i class="icon-pencil"></i> Edit</a>
                    </div>
                    <?php endif ?>
                    ...
                    <div ng-cloak ng-show="clinicalFeatures.length > 0">
                        ...
                        <table class="table table-striped table-bordered table-dark">
                            ...
                            <tr ng-repeat="clinicalFeature in clinicalFeatures | filter:clinicalFeatureFilter | orderBy:'-information_content' | limitTo:clinicalFeatureDisplayLimit">
                                <td>
                                    <a href="?q=node/{{ boneDysplasia.nid }}/clinical-feature/{{clinicalFeature.tid}}" title="{{clinicalFeature.name}}">
                        ...
                        <div class="clearfix" ng-show="clinicalFeatures.length > clinicalFeatureDisplayLimit" style="text-align: center">
                            <a ng-show="(clinicalFeatures | filter:clinicalFeatureFilter).length > clinicalFeatureDisplayLimit" href class="btn btn-more" ng-click="clinicalFeatureDisplayLimit = clinicalFeatures.length"><i class="icon-chevron-down icon-black"></i> Show All</a>
                            <a ng-show="(clinicalFeatures | filter:clinicalFeatureFilter).length == clinicalFeatureDisplayLimit" href class="btn btn-more" ng-click="clinicalFeatureDisplayLimit = 10"><i class="icon-chevron-up icon-black"></i> Show Less</a>
                        </div>
            ...
            <div class="span4">
                ...
                <section>
                    <?php if((user_access('administer site configuration')) || is_array($user->roles) && in_array('sk_moderator', $user->roles)): ?>
                    <div class="pull-right">
                        <a ng-click="showEditDetails()" href data-toggle="modal" role="button"  class="btn" ><i class="icon-pencil"></i> Edit</a>
                    ...
                    <dl class="dl-horizontal dl-horizontal-squished" ng-show="moi.name.length">
                        ...
                        <dd ng-show="moi"><a ng-href="{{moi.field_moi_term_uri.und[0].value}}" target="_blank">{{moi.name}}</a></dd>
                ...
                <section>
                    <?php if((user_access('administer site configuration')) || is_array($user->roles) && in_array('sk_moderator', $user->roles)): ?>
                    <div class="pull-right">
                        <a href ng-click="showEditGenes()" data-toggle="modal" role="button" class="btn"><i class="icon-pencil"></i> Edit</a>
                    </div>
                    <?php endif; ?>

                    <h3>Genes</h3>
                    <p ng-show="!genes.length" class="muted">'{{ boneDysplasia.title }}' is associated with {{ genes.length }} gene.</p>
                    <ul>
                        <li ng-repeat="gene in genes"><a ng-href="?q=node/{{boneDysplasia.nid}}/gene/{{gene.nid}}">{{ gene.title }}</a></li>
                    </ul>
                </section>
    ...
    <div cm-modal="showEditingPanel" ng-switch on="editingPanel" class="modal modal-dark fade hide" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-switch" ng-switch-when="edit-details">
            ...
            <div class="modal-body">
                <div class="modal-body-inner">
                    ...
                    <div class="section-top">
                        ...
                        <select class="full-width" ng-model="edit.editedMoi" ng-options="blah.name for blah in mois" ng-init="7"></select>
                    </div>
                </div>
            ...
            <!-- Modal Footer -->
            <div class="modal-footer modal-footer-bottom">
                <a href class="btn btn-success" ng-click="saveDetails(editedOMIM, edit.editedMoi)"><i class="icon-ok icon-white"></i> Save</a>
            </div>
            <!-- /Modal Footer -->
        </div>
        ...
        <div class="modal-switch" ng-switch-when="add-statement">
            ...
            <!-- Modal Footer -->
            <div class="modal-footer modal-footer-bottom">
                <a href class="btn btn-success" ng-click="addStatement(newStatement); newStatement = ''"><i class="icon-plus icon-white"></i> Add Statement</a>
            </div>
            <!-- /Modal Footer -->
        </div>
        ...
        <div class="modal-switch" ng-switch-when="edit-description">
            ...
            <!-- Modal Footer -->
            <div class="modal-footer modal-footer-bottom">
                <a href class="btn btn-success" ng-click="saveEditedDescription(editedDescription)"><i class="icon-ok icon-white"></i> Save Description</a>
            </div>
            <!-- /Modal Footer -->
        </div>
        ...
        <div class="modal-switch" ng-switch-when="edit-genes">
            ...
            <div class="modal-body">
                <div class="modal-body-inner">
                    ...
                    <!-- Search box -->
                    <form>
                        <search model="$parent.editGeneSearch" change="searchForGenes($parent.editGeneSearch); newGeneName=editGeneSearch" placeholder="Search for a Gene"></search>
                    </form>
                    ...
                    <div style="margin-bottom: 20px">
                        ...
                        <div ng-repeat="gene in editingGenes" style="overflow: auto; margin-bottom: 10px">
                            ...
                            <a ng-show="!gene.added" ng-click="addGeneToBoneDysplasia(gene, boneDysplasia)" class="btn btn-success pull-right" href><i class="icon-plus icon-white"></i> Add</a>
                            <a ng-show="gene.added" ng-click="removeGeneFromBoneDysplasia(gene, boneDysplasia)" class="btn btn-danger pull-right" href><i class="icon-minus icon-white"></i> Remove</a>
                        </div>
                        ...
                        <div ng-show="showAddNewGeneForm">
                            ...
                            <div class="input-append">
                                ...
                                <a ng-click="addNewGeneToBoneDysplasia(newGeneName, boneDysplasia)" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Gene</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <p ng-show="!editGeneSearch" class="muted info">Want to find another Gene? <br/>Try using the search bar above e.g. '<a href ng-click="$parent.editGeneSearch = 'FGFR3'; searchForGenes($parent.editGeneSearch)">FGFR3</a>'</p>
                    <!-- /Helpful Prompt -->
                </div>
            </div>
            <!-- /Modal Body -->
    ...
    <div id="new-bone-dysplasia" class="modal modal-dark hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        ...
        <div class="modal-footer modal-footer-bottom">
            <button class="btn btn-success" ng-disabled="!newDisorderName.length" ng-click="createNewBoneDysplasia(newDisorderName)">Create Bone Dysplasia</button>
        </div>
    </div>
