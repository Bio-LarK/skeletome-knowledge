...
<div style="overflow: auto; margin-top:20px; margin-bottom: 20px;">
    <a class="btn btn-success pull-right" href="/?q=node/add/forum/0">
        <i class="icon-plus icon-white"></i> Add new Forum topic
    </a>
</div>


<table class="table table-dark table-bordered" id="forum-topic-<?php print $topic_id; ?>">
  <thead>
